...
class DataFrameAccessor:
    ...
    def to_indexset(self) -> IndexSet1D[Any] | IndexSetND[tuple[Any, ...]]:
        ...
        Note: The `docplex-extensions` pacakge has to be imported first to use this method with
        `pandas`.
        ...
        See Also
        --------
        pandas.Series.dex.to_indexset : Cast a Series into an IndexSet1D.
        pandas.Index.dex.to_indexset : Cast an Index into an IndexSet1D/IndexSetND.
        ...
        if self._df.columns.size > 1:  # multi-column df
            ...
            return IndexSet1D(self._df.squeeze(axis=1).tolist(), name=str(self._df.columns[0]))
    ...
    def to_paramdict(
        ...
        See Also
        --------
        pandas.Series.dex.to_paramdict : Cast a Series into a ParamDict1D/ParamDictND.
        ...
        >>> inventory_units.dex.to_paramdict()
        ...
        if self._df.columns.size == 1:  # single-column df
            if self._df.index.nlevels > 1:  # multi-level index
                ...
                return ParamDictND(
                    self._df.squeeze(axis=1).to_dict(),
                    key_names=key_names,
...
class SeriesAccessor:
    ...
    def to_indexset(self) -> IndexSet1D[Any]:
        ...
        See Also
        --------
        pandas.DataFrame.dex.to_indexset : Cast a DataFrame into an IndexSet1D/IndexSetND.
        pandas.Index.dex.to_indexset : Cast an Index into an IndexSet1D/IndexSetND.
    ...
    def to_paramdict(
        ...
        See Also
        --------
        pandas.DataFrame.dex.to_paramdict : Cast a single-column DataFrame into a ParamDict1D/
            ParamDictND.
